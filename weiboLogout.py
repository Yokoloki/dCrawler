...
class Fetcher(object):
    ...
    def login(self, username, pwd):
        ...
        url = 'http://3g.sina.com.cn/prog/wapsite/sso/login.php?ns=1&revalid=2&backURL=http%3A%2F%2Fweibo.cn%2F&backTitle=%D0%C2%C0%CB%CE%A2%B2%A9&vt=4'
...
if __name__ == "__main__":
    acc = {'user': 'crawler2013_28@163.com', 'psw': '654123'}
    fetcher = Fetcher()
    fetcher.login(acc['user'], acc['psw'])
    fetcher.logout()
